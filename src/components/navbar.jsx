...
import Pokelogo from "../assets/pika-logo.png"
...
export default function Navbar() {
    ...
    return (
        ...
        <a href="/home" className="flex items-center">
            <img src={Pokelogo} className="h-12 mr-3" alt="Pika Logo" />
            <span className="navbar-text-logo self-center text-2xl font-bold whitespace-nowrap dark:text-white text-blue-400">Pikapedia</span>
        </a>
